...
import com.xan.nrcdemo.databinding.FragPassportBinding
...
class passportFragment : Fragment() {
    ...
    lateinit var binding: FragPassportBinding
    ...
    private val viewModel: passportViewModel by lazy {
        ViewModelProviders.of(this).get(passportViewModel::class.java)
    }
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.frag_passport, container, false
        )
        binding.lifecycleOwner = this
        viewModel.context = requireActivity()
        binding.button.setOnClickListener {
            viewModel.setMyanRequest(imageStringFront!!)
        ...
        viewModel.myanResponseModel.observe(requireActivity(), androidx.lifecycle.Observer {
            if (it != null) {
                binding.DCountryCode.text =
                    viewModel.myanResponseModel.value?.result?.country_code
                binding.DSurName.text =
                    viewModel.myanResponseModel.value?.result?.surname
                binding.DGivenName.text =
                    viewModel.myanResponseModel.value?.result?.given_name
                binding.DpassportNumber.text =
                    viewModel.myanResponseModel.value?.result?.passport_number
                binding.dbirthday.text =
                    viewModel.myanResponseModel.value?.result?.date_of_birth
                binding.dSex.text =
                    viewModel.myanResponseModel.value?.result?.sex
                binding.dexpireDate.text =
                    viewModel.myanResponseModel.value?.result?.date_of_expiry
        ...
        viewModel.showLoading.observe(requireActivity(), androidx.lifecycle.Observer {
            if (it) {
